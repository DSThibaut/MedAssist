...
Glutamine = Medicament.create!(name: "Glutamine", unit: "Vitamine", stock: 100)
...
Dantrium = Medicament.create!(name: "Dantrium", unit: "Comprimé", stock: 100)
Lioresal = Medicament.create!(name: "Liorésal", unit: "Comprimé", stock: 100)
Mexitil = Medicament.create!(name: "Mexitil", unit: "Gellule", stock: 38)
Eplerenone = Medicament.create!(name: "Eplerenone", unit: "Comprimé", stock: 100)
...
Doliprane = Medicament.create!(name: "Doliprane", unit: "Comprimé", stock: 100)
Daffalgan = Medicament.create!(name: "Daffalgan", unit: "Comprimé", stock: 100)
Efferalgan = Medicament.create!(name: "Efferalgan", unit: "Comprimé", stock: 100)
