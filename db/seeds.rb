...
MedicalCare.create!(title: "Traitement pour le Diabète", description: "Defaut d'insuline dans le corps", user_id: 4, start_date: "2023-07-01" , end_date: "2023-07-10")
MedicalCare.create!(title: "Traitement pour le Diabète", description: "Defaut d'insuline dans le corps", user_id: 5, start_date: "2023-07-12" , end_date: "2023-07-15")
