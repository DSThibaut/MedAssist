...
Glutamine = Medicament.create!(name: "Glutamine", unit: "Vitamine", stock: 32)
Vitamine_D = Medicament.create!(name: "Vitamine D", unit: "Vitamine", stock: 26)
Calcium = Medicament.create!(name: "Calcium", unit: "Complément", stock: 38)
Acide_gras_Omega_3 = Medicament.create!(name: "Acide gras Oméga 3", unit: "Complément", stock: 100)
Haelan = Medicament.create!(name: "Haelan", unit: "Complément", stock: 28)
...
Eplerenone = Medicament.create!(name: "Eplerenone", unit: "Comprimé", stock: 58)
...
Doliprane = Medicament.create!(name: "Doliprane", unit: "Comprimé", stock: 52)
Daffalgan = Medicament.create!(name: "Daffalgan", unit: "Comprimé", stock: 64)
Efferalgan = Medicament.create!(name: "Efferalgan", unit: "Comprimé", stock: 24)
Dilantin = Medicament.create!(name: "Dilantin", unit: "Comprimé", stock: 36)
